...
const FACTORY_FEATURES: FeatureDefinition[] = [
  ...
  // ─── Phase 2 Features ──────────────────────
  {
    ...
    description: 'License key generation, activation, validation and tier management',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  },
  {
    id: 'permissions',
    label: 'Permissions',
    description: 'Granular role-based permissions with 35+ permission types',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  },
  {
    id: 'audit',
    label: 'Audit Logs',
    description: 'Activity audit trail with search, export and retention policies',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  },
  {
    id: 'backups',
    label: 'Backup System',
    description: 'Database backup creation, restoration and management',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  },
  {
    id: 'admin',
    label: 'Admin Panel',
    description: 'System administration dashboard, user management, feature toggles',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  },
  {
    ...
    description: 'Export production, machine, shift and efficiency data as CSV/JSON',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  // ─── Phase 3 Features (SaaS Conversion) ────
  {
    id: 'tenants',
    label: 'Multi-Tenancy',
    description: 'Shared-database multi-tenancy with tenant isolation, CRUD, and usage metering',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  },
  {
    ...
    description: 'SaaS subscription plans, billing cycles, invoices, and usage metering',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  },
  {
    id: 'cloud-auth',
    label: 'Cloud Auth',
    description: 'Tenant-aware SaaS login, self-service signup and onboarding',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  },
  {
    ...
    description: 'Platform-wide analytics, MRR tracking, tenant overview, growth metrics',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  // Phase 4 features (Enterprise Enhancements)
  {
    id: 'super-admin',
    label: 'Super Admin',
    description: 'Platform-level super admin panel with tenant management, usage metering, impersonation',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
  ...
  },
  {
    id: 'offline-sync',
    label: 'Offline Sync',
    description: 'Outbox-based offline support with conflict resolution and sync queue',
    api: 'ENABLED',
    ui: 'ENABLED',
    apiVersion: 'v1',
    availableVersions: ['v1'],
