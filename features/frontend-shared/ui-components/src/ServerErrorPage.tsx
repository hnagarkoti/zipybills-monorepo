    ...
    >
      ...
      <View className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl px-4 py-3 mb-6 flex-row items-center w-full max-w-sm">
        ...
        <View className="flex-1">
          <Text className="text-xs font-semibold text-red-700 dark:text-red-400">Incident Detected</Text>
      ...
      {isDev && error && (
        ...
        >
          <View className="flex-row items-center justify-between px-4 py-3">
            <Text className="text-xs font-semibold text-slate-600 dark:text-gray-300">Error Details</Text>
            {showDetails
      ...
      <View className="flex-row gap-3">
        ...
        {onGoHome && (
          ...
          >
            ...
            <Text className="text-sm font-medium text-slate-600 dark:text-gray-300 ml-2">Dashboard</Text>
          </Pressable>
        )}
      </View>
